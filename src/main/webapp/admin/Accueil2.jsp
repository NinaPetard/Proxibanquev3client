...
<html lang="en">
    ...
    <body>
        ...
        <h1><strong>Bienvenue <c:out value="${utilisateur.prenom}"/> <c:out value="${utilisateur.nom}"/> !</h1> </strong>

    <section class="row">

        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <center><img class="img-responsive" src="assets/img/ProxiBanque.jpg" alt="logo" style="width:20%"><center><br>
                    <h4>Le virement a ete realise avec succès</h4>
                    <p> Le nouveau solde  du compte <c:out  value = "${NouveauSolde.typecompte}">${NouveauSolde.typecompte} </c:out> dont l'ID client : <c:out  value = "${NouveauSolde.idclient}">${NouveauSolde.idclient} </c:out>
                        est de <c:out value = "${NouveauSolde.solde}">${NouveauSolde.solde} </c:out> euros</p>
                                    ...
                                    <div class="form-bottom1">    
                                        <table class="table1">
                                            ...
                                            <c:forEach items="${Liste}" var="item">
                                                <tr>
                                            <form class="form-inline" method="POST" action ="ServletModifClient">
                                                ...
                                                <td><div class="form-group">
                                                        <input type="text" class="form-control5"  value="${item.codePostal}" name="code postal" readonly="readonly">
                                                    </div></td>
                                                <td><div class="form-group">
                                                        <input type="text" class="form-control5"  value="${item.ville}" name="ville" readonly="readonly">
                                                    </div></td>
                                                <td><div class="form-group">
                                                        <input type="text" class="form-control5"  value="${item.telephone}" name="telephone" readonly="readonly">
                                                    </div></td>
                                                <td><div class="form-group">     					
                                            ...
                                            <form class="form-inline" method="POST" action= "ServletCompte">
                                            ...
                                            <form class="form-inline" method="POST" action= "ServletChoixCompteVirement">
                                                <input name="idclient"  value="${item.idclient}"  style = visibility:hidden;>
